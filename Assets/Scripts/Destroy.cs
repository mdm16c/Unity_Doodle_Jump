    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Platform") {
            if (Random.Range(1, 15) == 1) {
                myEnemy = (GameObject)Instantiate(enemyPrefab, new Vector2(Random.Range(-5.5f, 5.5f), player.transform.position.y + (screenHeight + Random.Range(0.5f, 0.8f))), Quaternion.identity);
                myEnemy.SetActive(true);
            }
            if (Random.Range(1, 15) == 1) {
                myPowerUp = (GameObject)Instantiate(powerUpPrefab, new Vector2(Random.Range(-5.5f, 5.5f), player.transform.position.y + (screenHeight + Random.Range(0.5f, 0.8f))), Quaternion.identity);
                myPowerUp.SetActive(true);
            }

            if (Random.Range(1, 10) == 1) {
                myPlat = (GameObject)Instantiate(springPrefab, new Vector2(Random.Range(-5.5f, 5.5f), collision.transform.position.y + (screenHeight)), Quaternion.identity);
            }
            else if (Random.Range(1, 10) == 1) {
                myPlat = (GameObject)Instantiate(breakPrefab, new Vector2(Random.Range(-5.5f, 5.5f), collision.transform.position.y + (screenHeight)), Quaternion.identity);
            }
            else {
                myPlat = (GameObject)Instantiate(platformPrefab, new Vector2(Random.Range(-5.5f, 5.5f), collision.transform.position.y + (screenHeight)), Quaternion.identity);
            }
        }
